function [d1x,kdx,d1y,kdy]=diff_me_steady_change_speed(rho,theta,number,order,geometry)
%*****************************************************
...
% Outputs:
%D1, the difference scheme coefficient of first-order derivative
%KD, the position of grid points used in differential format
% Inputs:
%     rho(:), rho grids;   theta(:),theta grids
%Number, the number of grid points used to calculate each differential derivative
%Groemtry grid area partitioning and effective grid point boundaries
%Order in order differentiation calculation
%*****************************************************
nt1=geometry.nt1;
...
%%
%Due to the singularity of the metric at point X, its value cannot be applied in the derivative scheme
%The following section will update the difference format between the boundary line and the X point of the cross
%There is obvious singularity near point X, and higher-order schemes should be used for better processing
