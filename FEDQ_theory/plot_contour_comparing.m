...
%Post processing programs required for writing articles
%This program is used to draw partitioned grids and delineate boundaries
%This program is used to compare the difference between the solved equal flux surface and the real equal flux surface
nt1=geometry.nt1;
